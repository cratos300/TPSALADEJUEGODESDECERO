...
export class MayorMenorComponent implements OnInit {
  ...
  harcodear()
  {
    ...
    this.foto2.respuestaCorrecta = "Leonel Messi";
    ...
    this.foto3.respuestaCorrecta = "Mole Moli";
    ...
    this.foto4.respuestaCorrecta = "Paulo Londra";
    ...
    this.foto5.respuestaCorrecta = "Esteban Andrada";
    ...
    this.foto6.respuestaCorrecta = "Marley";
    ...
    this.foto7.respuestaCorrecta = "Julieta Prandi";
    ...
    this.foto8.respuestaCorrecta = "Higuain";
    ...
    this.foto9.respuestaCorrecta = "Shakira";
    ...
    this.foto10.respuestaCorrecta = "Angelina Jolie";
  }
}
